...
import id.itborneo.cekongkir.data.remote.mapbox.MapBoxIntance
import id.itborneo.cekongkir.data.remote.mapbox.url_end
...
class MapReadyCallback(private val detailActivity: DetailActivity) : OnMapReadyCallback {
